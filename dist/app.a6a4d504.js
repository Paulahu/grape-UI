...
!function (a) {
  ...
  l = function l() {
    ...
    o.innerHTML = s, s = null, (a = o.getElementsByTagName('svg')[0]) && (a.setAttribute('aria-hidden', 'true'), a.style.position = 'absolute', a.style.width = 0, a.style.height = 0, a.style.overflow = 'hidden', t = a, (l = document.body).firstChild ? (e = t, (c = l.firstChild).parentNode.insertBefore(e, c)) : l.appendChild(t));
  ...
  }, document.addEventListener('DOMContentLoaded', _e, !1)) : document.attachEvent && (c = l, o = a.document, i = !1, (_d = function d() {
    try {
