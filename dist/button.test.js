...
exports.default = _default;
        var $a149cc = exports.default || module.exports;
      
      if (typeof $a149cc === 'function') {
        $a149cc = $a149cc.options;
      }
    
        /* template */
        Object.assign($a149cc, (function () {
          var render = function() {
  var _obj
  var _vm = this
  var _h = _vm.$createElement
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a149cc', $a149cc);
          } else {
            api.reload('$a149cc', $a149cc);
          }
        }
