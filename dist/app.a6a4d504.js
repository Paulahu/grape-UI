...
!function (t) {
  ...
  e = function e() {
    ...
    i.innerHTML = c, c = null, (t = i.getElementsByTagName('svg')[0]) && (t.setAttribute('aria-hidden', 'true'), t.style.position = 'absolute', t.style.width = 0, t.style.height = 0, t.style.overflow = 'hidden', a = t, (e = document.body).firstChild ? (l = a, (o = e.firstChild).parentNode.insertBefore(l, o)) : e.appendChild(a));
  ...
  }, document.addEventListener('DOMContentLoaded', _l, !1)) : document.attachEvent && (o = e, i = t.document, n = !1, (_d = function d() {
    try {
...
_chai.default.use(_chaiSpies.default); //单元测试
//用例1
